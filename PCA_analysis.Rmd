...
```{r}
#cargamos los datos
datos<-read.csv2("/Users/miguel/Desktop/Mineria de datos/autos.csv",sep=";",header=T)
```
...
# a)Análisis de las Componentes Principales
```{r}
#2. PCA 
...
# c)Contribución de las variables a las componentes principales
```{r}
round(var$contrib,2)
